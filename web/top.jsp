  ...
  <tr>
    ...
    <td width='80%' align="right" valign="bottom">
      ...
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：<span class="username" ><font color="red">${sessionScope.loginUser.user.user_name}</font></span>，欢迎使用项目平台管理系统！
        	
        	[<a href="index.jsp" target="_top">主页</a>]
        	[<a href="modpassword.jsp" target="_blank">修改密码</a>]
        	[<a href="javascript:void(0);" onClick="parent.location.href='/ProjectManagementSystem/logout'" target="_login">注销退出</a>]&nbsp;
      </td>
      </tr>
      <tr>
