...
<title>main</title>
<base target="_self">
<link rel="stylesheet" type="text/css" href="web/skin/css/base.css" />
<link rel="stylesheet" type="text/css" href="skin/css/main.css" />
</head>
<body leftmargin="8" topmargin='8'>
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><div style='float:left'> <img height="14" src="skin/images/frame/book1.gif" width="20" />&nbsp;欢迎使用项目平台管理系统</div>
    ...
    <td height="30" colspan="2" align="center" valign="bottom"><table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
          ...
          <td width="85%" valign="bottom"><div class='icoitem'>
            ...
            <div class='icoitem'>
              <div class='ico'><img src='web/skin/images/frame/manage1.gif' width='16' height='16' /></div>
            ...
            <div class='icoitem'>
              ...
              <div class='txt'><a href='message-give.jsp'><u>收件箱</u></a></div>
            </div>
            <div class='icoitem'>
...
<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="75%" bgcolor="#FFFFFF">${sessionScope.loginUser.user_roleName}</td>
  </tr>
</table>
</body>
</html>